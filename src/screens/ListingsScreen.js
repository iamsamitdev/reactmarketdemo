...
import { FlatList, StyleSheet, Image, Text } from 'react-native'
    ...
    <Screen style={styles.screen}>
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          // <Image source={{uri: 'https://source.unsplash.com/1024x768/?nature'}} style = {{width: 100, height: 100, resizeMode : 'stretch', margin: 5 }} />
